...
def cheap_grid_charge_hours():
    ...
    chargeHours['MaxChargingLevelToday'] = max(todays_max_battery_level, tomorrow_max_battery_level, charging_plan[day]['total_needed_battery_level'], get_min_charge_limit_battery_level())
...
def is_charging():
    ...
    try:
        ...
        elif charger_status in ("awaiting_start", "ready_to_charge"):
...
if INITIALIZATION_COMPLETE:
    ...
    @time_trigger(f"cron(0/15 * * * *)")
    def cron_is_charging(trigger_type=None, var_name=None, value=None, old_value=None):
