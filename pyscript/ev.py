...
COMMENT_DB_YAML = {
    ...
    "power_consumption_entity_id_include_powerwall_charging": "Home power consumption include powerwall charging (Watt entity)",
    "power_consumption_entity_id_include_powerwall_discharging": "Home power consumption include powerwall discharging (Watt entity)",
    ...
    "powerwall_battery_size": "Powerwall battery size (kWh)",
    "inverter_discharging_power_limit": "Inverter discharging power limit (Watt)",
    "powerwall_charging_power_limit": "Powerwall charging power limit (Watt)",
    "powerwall_discharging_power": "Powerwall discharging power (Watt), used to charge ev from powerwall, when powerwall battery level is above ev_charge_after_powerwall_battery_level",
